...
void zoomout();
void printspectrum();
void fourspectra(XSPECTRO *, FILE *);
void printwav();
void savdft();
void dofltr();
void copysav();

int quickspec(XSPECTRO *, short *);
int tilt(int *, int, int *);
void ps_toplabel(XSPECTRO *, FILE *, float ,int , char *, char *, char *, char *, char *);
void sc_toplabel(XSPECTRO *, INFO *, float ,int ,char *, char *, char *,char *, char *);
void mkwnd(XSPECTRO *);
int testhidden(XSPECTRO *);
void zap_insig_peak(XSPECTRO *);
void getform(XSPECTRO *);
