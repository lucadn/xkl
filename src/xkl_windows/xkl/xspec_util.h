/*
 * $Log: xspec_util.h,v $
 * Revision 1.14  2002-06-13 11:15:20-04  tiede
...
void rectofile(Widget, XtPointer, XtPointer);
...
int mstox(XSPECTRO *, int, float);
void expdraww(Widget, XtPointer, XtPointer);
void  postgvs(XSPECTRO *, FILE *);
int readgram(XSPECTRO *);
void initime(XSPECTRO *); 
int findspecindex(XSPECTRO *,int);
void addgram(XSPECTRO *);
void findseg(XSPECTRO *,int);
void strip_path(char *, char *);
int xoffset(XSPECTRO *);
int yoffset(XSPECTRO *);
int findxmax(XSPECTRO *, int);
int findymax(XSPECTRO *, int);
void dotitles(XSPECTRO *);
int rborder(XSPECTRO *, int); 
int bborder(XSPECTRO *, int);
int samptox(XSPECTRO *, int, int);
void dowavtitle(XSPECTRO *); 
#endif /*XSPEC_UTIL_H*/
